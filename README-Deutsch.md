...
*   **Dieser Leitfaden ist ein lebendes Dokument.** Zögere nicht, einen Pull Request einzureichen oder Ihre eigene Version dieses Leitfadens [auf GitHub](https://github.com/narwhalacademy/zebra-crossing) zu forken.
...
### ☕️ Unterstütze diesen Leitfaden

*   [Lade uns einen virtuellen Kaffee ein](https://ko-fi.com/narwhalacademy)
*   Teile diesen Leitfaden mit Ihren Freunden und Ihrer Community!
*   [Sende Ihr Feedback](mailto:contact@narwhalacademy.org) oder [trage auf GitHub zum Leitfaden bei](https://github.com/narwhalacademy/zebra-crossing).
...
_Leider sind die rechtlichen Schutzmaßnahmen in Bezug auf Metadaten meist schwach oder gar nicht vorhanden._
...
Die erste Sperre ist in der Regel Ihr Kontopasswort. Die zweite Sperre hat eine andere Form und/oder erfolgt über einen anderen Kanal – meist als Code, der über eine App oder eine Textnachricht (SMS) an Ihr Telefon gesendet wird. Diese zusätzliche Sperre wird in der Regel als _Zwei-Faktor-Authentifizierung_ (abgekürzt _2FA_) oder _Zwei-Schritt-Verifizierung_ bezeichnet.
...
*   **Aktivieren Sie die Zwei-Faktor-Authentifizierung für die wichtigen Konten**, die Sie gerade identifiziert haben. So finden Sie eine Anleitung dazu:
    ...
    *   Suchen Sie den Kontoanbieter auf [2fa.directory](https://2fa.directory)
*   **Verwenden Sie eine Authentifizierungs-App, falls eine verfügbar ist.** Diese sind sicherer als der Empfang Ihres 2FA-Codes per SMS.
    *   Empfohlene Apps:
        *   [2FAS](https://2fas.com) (wenn Sie nur ein Gerät zum Abrufen von Authentifizierungscodes verwenden)
        *   [Ente Auth](https://ente.io/auth/) (wenn Sie die Codes auf mehreren Geräten synchronisieren möchten)
...
*   **Stellen Sie sicher, dass das Betriebssystem Ihres Geräts weiterhin Updates empfangen kann:**
    *   Wenn der Kauf Ihres Smartphones oder Computers bereits mehr als drei Jahre zurückliegt, sollten Sie überprüfen, ob Sie weiterhin Updates erhälten.
        *   Für Smartphones: Suchen Sie [Ihr Gerät auf endoflife.date](https://endoflife.date/tags/device) und stellen Sie sicher, dass es noch als „unterstützt“ aufgeführt ist.
        *   Für macOS: Finden Sie heraus, welches Betriebssystem Sie verwenden. Klicken Sie auf das Apple-Logo in der oberen linken Ecke und dann auf `„Über diesen Mac`“. Vergewissern Sie sich anschließend auf [dieser endoflife.date-Seite](https://endoflife.date/macos), dass dort noch „Service-Status: Ja“ steht.
        *   Für Windows: Finden Sie heraus, welches Betriebssystem Sie verwenden. `Start → Einstellungen → System → Info`. Vergewissern Sie sich anschließend auf [dieser endoflife.date-Seite](https://endoflife.date/windows), dass es weiterhin Sicherheitsupdates erhält.
...
_👍 Ausgezeichnet! Diese einfachen Schritte sorgen tatsächlich „meistens“ für Ihre Sicherheit. Stellen Sie sich das wie ein gutes, solides Schloss an Ihrer Haustür vor. Es ist nicht narrensicher, aber es schützt Ihr Zuhause in den meisten Fällen. Fahren Sie fort, um die kleinen Dinge zu sichern, die später zu Schwachstellen werden könnten._
...
Was am besten funktioniert, ist für jeden unterschiedlich, und Sie mussen sich nicht auf nur eine Option beschränken – kombinieren sie ruhig nach Belieben. Eine ausführlichere Anleitung und Erläuterung zu den drei Optionen findest du in Michael Horowitz’ Artikel [„The world's BEST password advice](https://michaelhorowitz.com/BestPasswordAdvice.php) “.
...
Hier ist ein Beispiel für eine einfache Formel aus [„A Defensive Computing Checklist](https://defensivecomputingchecklist.com/indexold.php#passwoyds)“:
...
*   1Password: [Lernen Sie Ihr Notfall-Kit kennen](https://support.1password.com/emergency-kit/)
*   BitWarden: [Wiederherstellungscodes](https://bitwarden.com/help/two-step-recovery-code/#get-your-recovery-code) (füge Ihr Master-Passwort nach dem Ausdrucken hinzu)
...
*   [Google (einschließlich Gmail)](https://support.google.com/accounts/answer/1187538?hl=en)
*   [Instagram](https://www.facebook.com/help/1006568999411025/)
*   [Facebook](https://www.facebook.com/help/148104135383285/)
*   [Apple (einschließlich iCloud)](https://support.apple.com/en-us/109345)
...
*   **Aktivieren Sie die Ortungsfunktion für Ihre Geräte, falls Sie diese verlieren sollten.** So können Sie Ihre Geräte aus der Ferne finden und löschen, indem Sie sich auf einer Website anmelden, falls sie jemals verloren gehen sollten.
    *   Anleitungen für:
        ...
        *   [Windows](https://support.microsoft.com/en-us/account-billing/find-and-lock-a-lost-windows-device-890bf25e-b8ba-d3fe-8253-e98a12f26316) (Mein Gerät finden)
*   **Deaktivieren Sie die 2G-Konnektivität auf Ihrem Smartphone (nur Android)**. Die 2G-Mobilfunktechnologie ist veraltet und weist Sicherheitslücken auf, die es Betrügern ermöglichen, gefälschte SMS zu versenden. So deaktivieren Sie sie auf Android:
    ...
    *   Wenn diese Option nicht angezeigt wird, öffnen Sie die Telefon-App und geben Sie `*#*#4636#*#*` ein `.` Ein `Test` bildschirm wird angezeigt. Wählen Sie `„Telefoninformationen“` und ändern Sie dann den `„Bevorzugten Netzwerktyp“` so, dass er mit der aktuellen Auswahl übereinstimmt, jedoch ohne `GSM`. Um zu sehen, wofür die einzelnen Abkürzungen stehen, lesen Sie [die](https://en.wikipedia.org/wiki/Comparison_of_mobile_phone_standards#Comparison_of_wireless_Internet_standards) Wikipedia [\-Seite „Vergleich von Mobilfunkstandards](https://en.wikipedia.org/wiki/Comparison_of_mobile_phone_standards#Comparison_of_wireless_Internet_standards)“.
...
*   **Wenn Sie Microsoft Office verwenden: Deaktivieren Sie Makros.** Makros sind kleine Codeabschnitte, die Vorgänge automatisieren und von Angreifern ausgenutzt werden können. Da sie manchmal dennoch nützlich sein können, empfehlen wir die Option `„Alle Makros mit Benachrichtigung deaktivieren“`, mit der Sie Makros aus vertrauenswürdigen Quellen manuell ausführen lassen können.
    *   Anleitung für:
        ...
        *   [Windows](https://support.microsoft.com/en-us/office/macros-in-office-files-12b036fd-d140-4e74-b45e-16fed1a7e5c6), was unter Umständen [spezielle Einstellungen für Excel](https://support.microsoft.com/en-us/office/change-macro-security-settings-in-excel-a97c09d2-c082-46b8-b19f-e8621e8fe373) erfordert
...
_Denken Sie daran: Die Verschlüsselung ist nur dann voll wirksam, wenn das Gerät ausgeschaltet ist!_

*   **Verschlüsseln Sie die Festplatte Ihres Computers.**
    *   Anleitung für:
        *   [macOS](https://support.apple.com/en-us/HT204837).
        *   [Microsoft Windows](https://support.microsoft.com/en-us/windows/device-encryption-in-windows-10-ad5dcf4b-dbe0-2331-228f-7925c2a3012d) (verwenden Sie [BitLocker](https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-overview), falls verfügbar).
...
*   **Verschlüsseln Sie Ihre Backup-Festplatten.**
    *   Anleitung für:
        *   [macOS (wenn Sie Time Machine verwenden)](https://support.apple.com/en-ca/guide/mac-help/mh21241/mac)
...
*   Google [Kalender-Einstellungen](https://calendar.google.com/calendar/r/settings) `→ Termin-Einstellungen → Einladungen zu meinem Kalender hinzufügen: Wenn ich auf die Einladung per E-Mail antworte`
...
*   **Laden Sie verdächtige Anhänge auf [VirusTotal](http://www.virustotal.com) hoch**, um sie analysieren zu lassen. _Beachten Sie, dass an VirusTotal übermittelte Dateien möglicherweise an mehrere Sicherheitsforscher weitergegeben werden; übermitteln Sie daher keine sensiblen Informationen._
...
*   **Löschen Sie die Daten auf Ihren Geräten vollständig, bevor Sie diese spenden oder weitergeben.** Wenn Sie Ihre Telefone und Computer verschlüsselt haben (wie zuvor empfohlen), reicht in den meisten Fällen ein standardmäßiges Zurücksetzen auf die Werkseinstellungen aus.
    *   Wenn Sie eine zusätzliche Sicherheitsstufe für die Festplatten Ihres Computers wünschen, lesen Sie [den Leitfaden von Wired zu diesem Thema](https://www.wired.co.uk/article/securely-wipe-android-iphone-hard-disk).
...
*   **Deaktivieren Sie, wo immer möglich, Lesebestätigungen in Messaging-Apps.** Das mag zunächst unbequem erscheinen, aber auf lange Sicht haben Sie mehr Privatsphäre und Freiheit, wenn andere _nicht_ wissen, ob Sie ihre Nachrichten gelesen haben oder nicht.
*   Hier findest du Links und Anleitungen für die am häufigsten genutzten Plattformen/Apps:
    *   **Plattformen/Apps mit Datenschutzeinstellungen, die über einen Desktop-Browser verfügbar sind:**
        *   Facebook: [Datenschutz-Check](https://www.facebook.com/privacy/checkup/)
        *   Google: [Datenschutz-Check](https://myaccount.google.com/intro/privacycheckup)
        *   YouTube: [Kontodatenschutz](https://www.youtube.com/account_privacy)
        *   X/Twitter: [Datenschutz und Sicherheit](https://twitter.com/settings/privacy_and_safety)
        *   Reddit: [Sicherheit und Datenschutz](https://www.reddit.com/settings/privacy)
...
*   **Schränken Sie ein, wie Facebook Sie auf anderen Websites nachverfolgt**, indem Sie [die Off-Facebook-Aktivitäten](https://www.facebook.com/off_facebook_activity) löschen und die Verbindung trennen.
...
*   **Verhinderen, dass Bilder in Ihren E-Mails automatisch geladen werden**, da Unternehmen diese nutzen, um sich zu verfolgen.
    ...
    *   Proton Mail: Nicht erforderlich, da es eine Funktion gibt, die Bilder auf den eigenen Servern lädt, bevor sie an Sie gesendet werden. [Weitere Informationen finden Sie hier](https://proton.me/support/protonmail-images).
...
*   **Wenn Sie Bedenken hinsichtlich des Datenschutzes haben, verwenden Sie keine Amazon Echo (Lautsprecher) oder Ring (Heimsicherheitssystem).** Beide haben in der Vergangenheit Datenschutzverletzungen begangen. Falls Sie diese Geräte bereits besitzen, finden Sie hier einige Maßnahmen zur Risikominderung:
    ...
    *   Amazon Echo und Ring: Deaktivieren Sie die Funktion „Amazon Sidewalk“, die Ihre Internetverbindung mit Fremden teilt, indem Sie [diese Anweisungen](https://allaboutcookies.org/opt-out-amazon-sidewalk) befolgen.
...
*   **Wenn Sprachbefehle für Sie wichtig sind, finden Sie hier einige Möglichkeiten, dabei Ihre Privatsphäre zu wahren:**
    *   **Google Nest:** Gehen Sie zu [den Aktivitätskontrollen](https://myaccount.google.com/activitycontrols/audio) von Google Home und deaktivieren Sie `„Audioaufnahmen einbeziehen`“.
    ...
    *   **Sonos:** Siehe [die Empfehlungen der Mozilla Foundation](https://www.mozillafoundation.org/en/privacynotincluded/sonos-smart-speakers/).
*   **Stellen Sie bei Smart-TVs sicher, dass Sie die Datenerfassungsfunktion des Herstellers,** auch bekannt als automatische Inhaltserkennung (ACR), **deaktivieren**.
    *   Anleitung von: [Consumer Reports](https://www.consumerreports.org/privacy/how-to-turn-off-smart-tv-snooping-features-a4840102036/)
...
*   **Wechseln Sie Ihren Browser, wenn Sie Chrome oder Edge verwenden,** da beide eine schlechte Bilanz beim Schutz Ihrer Privatsphäre haben.
    ...
    *   Für macOS: Installiere [Firefox](https://www.firefox.com) oder verwende Safari.
    *   Für Android/Windows: Installiere [Firefox](https://www.firefox.com).
...
*   **Installieren Sie diese Webbrowser-Erweiterungen/Add-ons**, um aufdringliche Werbung und Tracker zu blockieren, sofern Ihr Browser diese unterstützt. Stellen Sie sicher, dass sie auch im privaten/Inkognito-Modus aktiviert sind.
    ...
    *   [uBlock Origin Lite](https://github.com/uBlockOrigin/uBOL-home) (falls Ihr Browser uBlock Origin nicht unterstützt)
...
*   **Anstatt in Ihrem normalen Browser ein `neues privates/Inkognito-Fenster` zu öffnen, verwenden Sie einen separaten, datenschutzoptimierten Browser**, wenn Sie möglichst wenig Tracking wünschen. Diese Browser funktionieren im Alltag vielleicht nicht ganz so gut, aber das liegt daran, dass sie über zusätzliche Schutzmaßnahmen verfügen. Außerdem ist es bei zwei separaten Apps weniger wahrscheinlich, dass Sie private und nicht-private Fenster verwechseln.
    ...
    *   Für macOS/Windows: [Mullvad Browser](https://mullvad.net/en/browser)
    *   Für iOS/Android: [Firefox Focus](https://www.firefox.com/browsers/mobile/focus/)
...
*   **Google:** [Meine Aktivitäten](https://myactivity.google.com)
*   **Facebook:** [Ihre Facebook-Daten](https://www.facebook.com/settings?tab=your_facebook_information)
*   **Amazon:** [Alexa-Datenschutzeinstellungen](https://www.amazon.com/b/?node=19149164011)
*   **Microsoft:** [Datenschutz für Ihr Konto](https://account.microsoft.com/privacy)
...
**Sagen Sie nichts, was Sie später bereuen könnten, in einer „privaten“ Gruppe** auf Slack, Discord, Facebook,**im** WhatsApp-Gruppenchat, im Telegram-Kanal oder**in** einem anderen „privaten“ Online-Forum. Hier ist der Grund dafür:
...
*   **Erstellen Sie für Dateien auf Ihrem Computer einen verschlüsselten, passwortgeschützten Tresor:**
    *   Empfohlenes Tool: [Cryptomator](https://cryptomator.org/).
...
*   **Für Dokumente auf Ihrem Smartphone gibt es mehrere Möglichkeiten:**
    *   Erstellen Sie einen ähnlichen Tresor mit einer App wie [Cryptomator](https://cryptomator.org/)(💰 für Mobilgeräte).
    ...
    *   Mit „Dateien“ von Google für Android können Sie einen `sicheren Ordner` erstellen, indem Sie [diese Anweisungen befolgst](https://support.google.com/files/answer/9935264).
*   **Für Fotos und Videos auf Ihrem Smartphone nutzen Sie die Funktionen Ihrer Standard-Foto-Apps:**
    ...
    *   Android Google Fotos: [Befolge diese Anleitung](https://support.google.com/photos/answer/10694388?co=GENIE.Platform%3DAndroid&oco=1) und lies den Abschnitt über automatische Backups sorgfältig durch.
    *   Android-Galerie: Die Standard-Galerie-App unterstützt keine versteckten Fotos. Lade daher eine alternative Galerie-App wie [„Fossify Gallery“](https://github.com/FossifyOrg/Gallery) herunter und aktiviere in den Einstellungen den Passwortschutz für versteckte Elemente.
...
*   **Kaufen Sie einen Sichtschutz für Ihren Laptop und Ihr Smartphone.** Diese aufklebbaren Folien verhindern, dass Umstehende sehen können, was auf Ihrem Bildschirm angezeigt wird. Beispiele für:
    *   Laptops: [3M-Sichtschutzfilter](https://www.3m.com/3M/en_US/p/c/office-supplies/workstation-accessories/screen-filters-protectors/laptop-filters/)
...
*   **Kaufen Sie ein Mobiltelefon, das immer die neuesten Software-Updates erhält** und bei Android keine unnötigen Apps und System-Add-ons installiert.
    ...
    *   Für andere Android-Handys:
        ...
        *   Vermeiden Sie günstigere Android-Smartphones von großen Unternehmen wie Samsung, Xiaomi oder OPPO: Diese sind dafür bekannt, unnötige und aufdringliche Apps hinzuzufügen. Ein Beispiel ist Samsungs [App-Plattform, die Apps ohne Erlaubnis installiert und ohne Ihre Zustimmung Daten über Sie sammelt](https://www.techfinitive.com/explainers/what-is-app-cloud-delete/).
*   **Nutzen Sie einen kostenpflichtigen VPN-Dienst** sowohl in öffentlichen Netzwerken (z. B. im Café) als auch zu Hause (um die Datenmenge zu reduzieren, die an Ihren Internet- oder Mobilfunkanbieter weitergegeben wird).
    ...
    *   Empfohlene VPNs: [Mullvad](https://mullvad.net), [IVPN💰](https://www.ivpn.net/)
    *   _Beachten Sie, dass iCloud Private Relay zwar einem VPN ähnelt, jedoch nur für den Datenverkehr über den Safari-Webbrowser gilt._
...
*   **Verwenden Sie Apps mit Open-Source-End-to-End-Verschlüsselungsprotokollen und benutzerfreundlichen Timern für selbstlöschende Nachrichten.**
    *   Empfohlene Apps:
        *   [Signal](https://signal.org/): Registrieren Sie sich mit einer Telefonnummer.
        *   [Wire](https://wire.com/): Registrieren Sie sich mit einer E-Mail-Adresse.
...
*   **Speichern und teilen Sie Dateien in der Cloud unter Verwendung von End-to-End-Verschlüsselung.**
    *   Empfohlene Apps: [Tresorit](https://tresorit.com/), [Proton Drive](https://proton.me/drive) 💰
    *   Für iCloud: Aktivieren Sie den erweiterten Datenschutz. [Siehe die Anweisungen von Apple](https://support.apple.com/en-us/HT212520).
    *   _Denken Sie daran: Auf Dropbox und Google Drive gespeicherte Dateien sind nicht Ende-zu-Ende-verschlüsselt._
*   **Sichern Sie Ihre Dateien online über eine durchgehend verschlüsselte Plattform.**
    *   Empfohlene App: [Arq](https://www.arqbackup.com/) 💰
...
*   **Starte Unterhaltungen mit `„Neuer geheimer Chat“`, damit sie Ende-zu-Ende-verschlüsselt sind.** Alle anderen Unterhaltungen und Gruppen sind dies nicht. _Leider bedeutet dies, dass Ihre Nachrichten nicht in Ihrer Desktop- oder Web-App angezeigt werden._
...
_👍👍👍👍 Wow, Sie haben es wirklich geschafft. Sie haben alle vier Stufen abgeschlossen! Sie haben alle Dinge (große und kleine) gesichert, Ihre digitale Privatsphäre drastisch verbessert und Ihre einige super sichere Tools und Tipps angeeignet. Sie haben alles getan, was wir für jeden als nützlich erachten. Gönn Ihre auf jeden Fall etwas Schönes als Belohnung._

_Von hier an geben wir Empfehlungen für Sonderfälle (Szenarien), gefolgt von einem kleinen Bonusabschnitt für technisch Versierte. Wenn derzeit keines der Szenarien auf sich zutrifft, sind Sie bestens gerüstet. Denken einfach daran: Die Szenarien sind hier, falls Sie sie jemals brauchen!_
...
*   **Erwägen Sie die Verwendung eines dauerhaften Pseudonyms oder einer kollektiven Identität,** insbesondere wenn Sie eine Person des öffentlichen Lebens sind. Weitere Informationen dazu, wie und warum, finden Sie unter:
    *   Tactical Tech: [Zen und die Kunst, Technologie für sich arbeiten zu lassen](https://gendersec.tacticaltech.org/wiki/index.php/Complete_manual#Creating_and_managing_identities_online)
...
*   **Kostenpflichtige Online-Dienste 💰** (zuverlässiger)
    *   [Hushed::](https://hushed.com) Bietet Nummern aus den USA, Kanada und Großbritannien
    *   [Burner::](https://www.burnerapp.com/) Bietet Nummern in den USA und Kanada
*   **Kostenlose Online-Dienste 🆓**
    *   [TextNow::](https://www.textnow.com/) Bietet werbefinanzierte US- und Kanada-Nummern
    *   [Google Voice::](https://voice.google.com/about) Bietet eine kostenlose US-Nummer, ist jedoch nur in den USA verfügbar
*   **Ihre lokalen Telefonanbieter 💰**
    *   Besorgen Ihnen einen Prepaid-Tarif oder einen günstigen SIM-Karten-Tarif

_Hinweis: Wenn Sie Ihre zweite Telefonnummer verlieren oder kündigen, können andere Personen sie kaufen und sich als sich ausgeben._
...
*   [SimpleLogin::](https://simplelogin.io) Mit Sitz in der Schweiz (als Teil der Proton Mail/VPN-Gruppe)
*   [addy.io](https://addy.io): Sitz in Großbritannien und der EU

#### Kaufen Sie anonym online ein

*   **Melden sich für eine datenschutzorientierte virtuelle Kreditkarte 💰** von [Privacy](https://privacy.com/)**an** (nur in den USA verfügbar). Sie hilft Ihnen dabei, a) Ihre Identität gegenüber dem Verkäufer zu verbergen und b) Ihre Einkäufe vor der Bank geheim zu halten.
...
*   **Holen Sie sich eine virtuelle Kreditkarte für kostenlose Testphasen** bei [Do Not Pay](https://donotpay.com/learn/virtual-credit-cards/) für Fälle, in denen Sie sich für einen kostenlosen Dienst anmelden möchten, ohne Ihre echten Kreditkartendaten anzugeben.
...
Befolgen Sie [die Anweisungen](https://support.apple.com/en-ca/guide/iphone/iph3ecf67d29/ios) von Apple, [um beides durchzuführen](https://support.apple.com/en-ca/guide/iphone/iph3ecf67d29/ios).

*   Wenn Sie iCloud nutzen, aktivieren Sie anschließend den erweiterten Datenschutz (der eine End-to-End-Verschlüsselung beinhaltet), indem Sie [diese Anweisungen](https://support.apple.com/en-us/108756) befolgen.
...
*   Sicherung auf Google One: Ein automatisierter Vorgang, der nur funktioniert, wenn Sie Google One haben oder abonnieren 💰. Im Gegensatz zu Apples iCloud wird jedoch keine End-to-End-Verschlüsselung unterstützt. Siehe [die Anweisungen von Google](https://support.google.com/android/answer/2819582).
...
Apple empfiehlt standardmäßig die Verwendung der Time Machine-App, die automatisch den gesamten Inhalt Ihres Computers auf einer externen Festplatte sichert. [Befolgen Sie die Anweisungen](https://support.apple.com/104984) und denken Sie daran, die Option `„Backups verschlüsseln“` zu aktivieren.

##### Windows

Windows verfügt über die Funktion „Dateiversionsverlauf“, die den Inhalt Ihres Computers automatisch auf einer externen Festplatte sichert. [Befolgen Sie die Anweisungen, um diese Funktion einzurichten](https://support.microsoft.com/windows/backup-and-restore-with-file-history-7bf065bf-f1ea-0a78-c1cf-7dcf51cc8bfc). Es gibt keine Option zur Verschlüsselung der Sicherung, daher müssen Sie die externe Festplatte manuell mit BitLocker verschlüsseln, indem [Sie diese Anweisungen befolgen](https://support.microsoft.com/en-us/windows/bitlocker-drive-encryption-76b92ac9-1040-48d6-9f5f-d14b3c5fa178). Leider enthalten einige Home-Versionen von Windows kein BitLocker, und die Workarounds zur Verwendung von Veracrypt mit dem Dateiversionsverlauf sind recht kompliziert ([siehe diese Beispielanleitung](https://usercomp.com/news/1480091/veracrypt-drive-for-win-11-file-history)).
...
*   Wenn Sie alles auf Ihrem Computer sichern möchten, empfehlen wir [Arq](https://www.arqbackup.com/), [Blackblaze](https://www.backblaze.com/) oder [IDrive](https://www.idrive.com). (Stellen Sie einfach sicher, dass Sie die End-to-End-Verschlüsselung aktivieren, die Blackblaze und IDrive als `„privaten Verschlüsselungsschlüssel“` bezeichnen.)
*   Wenn Sie nur bestimmte Ordner und Dateien sichern möchten, empfehlen wir [Tresorit](https://tresorit.com/) oder [Proton Drive](https://proton.me/drive).
...
*   **Schreib Ihnen zur Sicherheit die Telefonnummer des vertrauten Freundes/der Hotline** mit einem Permanentmarker**auf den Arm** (beispielsweise an die [Rote Hilfe] (https://rote-hilfe.de/).
...
*   **Kleiden Sie sich so, dass Sie _nicht_ auffallen.** Tragen Sie schlichte Kleidung, die keine Aufmerksamkeit erregt, verdecken Sie sichtbare Tattoos und setzen Sie eine Gesichtsmaske auf. Machen Sie es schwieriger, anhand eines Fotos identifiziert zu werden.
...
*   **Versuche, keine Fotos oder Videos aufzunehmen, auf denen Gesichter von Personen zu sehen sind.** Fotos von Personen von hinten sind in Ordnung. _Die einzige Ausnahme ist, wenn du ein Video von einem Konflikt aufnimmst, bei dem die Dokumentation entscheidend ist._
*   **Wenn auf einem Foto/Video Gesichter zu sehen sind, verwische diese unbedingt, bevor du sie online teilst.**
    *   Empfohlene Tools:
        *   Smartphone: [Signal-Tool zum Verwischen von Fotos](https://signal.org/blog/blur-tools)
        *   Computer: [Image Scrubber](https://everestpipkin.github.io/image-scrubber/) von Everest Pipkin
        *   Computer: [Das Tool zum Unscharfmachen von Gesichtern](https://support.google.com/youtube/answer/9057652?hl=en) von YouTube
*   **Für noch mehr Anonymität löschen Sie die Standort-Metadaten, bevor Sie ein Foto/Video teilen.**
    *   Empfohlene Tools:
        *   Computer: Everest Pipkins [Image Scrubber](https://everestpipkin.github.io/image-scrubber/)
...
Gruppen nutzen oft Social-Media-Plattformen (z. B. Instagram, X/Twitter), um Updates über ihre Arbeit zu posten. Eine beliebte Alternative ist die Nutzung [von Telegram](https://telegram.org/)\-Kanälen, um Nachrichten einseitig an ein großes Publikum zu senden (ohne Kommentare oder Antworten). Die Vorteile von Telegram-Kanälen:
...
Wenn Sie Updates nur an 1000 oder weniger Personen senden, können die neuen Funktionen [von Signal](https://www.signal.org/) dies ermöglichen und gleichzeitig ein Höchstmaß an Privatsphäre für beide Seiten gewährleisten:
...
Wenn Ihre Gruppe wächst, kann es sinnvoll sein, einen öffentlicheren Online-Raum einzurichten, um mit neuen Mitgliedern zu arbeiten. Gruppen wechseln oft zu Plattformen wie [Slack](https://slack.com/), [Mattermost](https://mattermost.com/) und [Discord](https://discord.com/), die mehrere Chatrooms innerhalb desselben Raums ermöglichen. Da diese Plattformen jedoch für Unternehmensumgebungen oder öffentliche Gaming-Communities konzipiert sind, sind ihre Datenschutzfunktionen sehr begrenzt. Wir empfehlen daher, diese Plattformen nur für die Öffentlichkeitsarbeit oder für quasi-öffentliche Nachrichten zu nutzen.
...
*   **Für kleine Gruppen mit bis zu zehn Personen nutze [Signal](https://www.signal.org/).** Die Anrufe sind Ende-zu-Ende-verschlüsselt und es werden keine Metadaten erfasst. Leider funktioniert die App bei langsameren Internetverbindungen nicht gut und erlaubt maximal 40 Teilnehmer pro Anruf.
*   **Für größere Gruppen:**
    *   Wenn Sie ein technisch versiertes Gruppenmitglied haben, das sich mit Systemadministration auskennt, richten Sie Ihren eigenen [BigBlueButton-](https://bigbluebutton.org/) oder [Jitsi-Server](https://jitsi.org/) ein. Die Verschlüsselung spielt eine geringere Rolle, wenn Sie die Daten kontrollieren (d. h. Sie können sie nach jedem Anruf löschen).
    *   Andernfalls greife auf die großen Tech-Plattformen [Zoom](https://zoom.us/) oder [Google Meet](https://meet.google.com/) zurück. (Zoom mag aufgrund seiner [End-to-End-Verschlüsselung](https://support.zoom.us/hc/en-us/articles/360048660871-End-to-end-E2E-encryption-for-meetings) als sicherere Wahl erscheinen, hat jedoch auch eine [schlechte Bilanz in Bezug auf Sicherheitsprobleme](https://www.tomsguide.com/news/zoom-security-privacy-woes).) Beachte jedoch, dass beide Plattformen Ihre Metadaten erfassen und der Gastgeber über ein registriertes Konto verfügen muss.
...
*   **Rufen Sie Gesundheitsinformationen ab, ohne verfolgt zu werden – nutzen Sie dazu [den Tor-Browser](https://www.torproject.org/download/).** Er funktioniert nicht gut für Websites, die eine Anmeldung erfordern, aber Sie sollten sich ohnehin nicht anmelden, um eine Nachverfolgung zu verhindern. Es gibt keine offizielle iOS-App, da diese einige Daten preisgibt; nutzen Sie daher die Desktop-Version, wenn Sie ein iPhone-Nutzer sind.
*   **Wenn Sie sich bei einem Konto anmelden mussen, seien Ihnen bewusst, dass dabei Datenrückstände entstehen, und versuche, diese zu minimieren:**
    *   **Verbergen Sie vor Ihrem Internetanbieter, welche Websites Sie besuchen, indem Sie ein VPN verwenden**.
        *   Empfohlene 💰 VPNs: [Mullvad](https://mullvad.net), [IVPN](https://www.ivpn.net/)
        *   Empfohlenes kostenloses VPN: [Proton VPN](https://protonvpn.com/free-vpn) (kostenlos für ein Gerät)
...
*   **Verwenden Sie die** in Abschnitt `„Stufe 4: Verwenden Sie end-to-end-verschlüsselte Apps` “ empfohlenen**Messaging-Apps** und denken Sie daran, die Funktion für selbstlöschende Nachrichten zu aktivieren.
...
*   **Verwenden Sie eine App, die Ihre Daten lokal speichert, oder nutzen Sie Stift und Papier.**
    *   Empfohlene Apps: [Euki](https://eukiapp.com/), [drip](https://dripapp.org/)
...
*   **Verwenden Sie eine E-Mail-Adresse mit End-to-End-Verschlüsselung.** Erwägen Sie, eigens für diesen Zweck eine neue einzurichten.
    *   Empfohlene Dienste: [Proton Mail](https://protonmail.com/), [Tuta Mail](https://tutanota.com/)
*   **Verbergen Sie Ihre Transaktionen**, indem Sie mit folgenden Zahlungsmitteln bezahlen:
    ...
    *   Eine datenschutzorientierte virtuelle Kreditkarte von [Privacy](https://privacy.com/) (nur in den USA erhältlich).
...
*   Kendra Albert, Maggie Delano und Emma Weils [„Okay, gut, reden wir über die Periodenverfolgung: Die ausführliche Erklärung“](https://medium.com/@maggied/okay-fine-lets-talk-about-period-tracking-the-detailed-explainer-2f45112eebb4)
...
*   **Speichere weniger Informationen auf Ihren Geräten.** Was Sie nicht haben, können sie Ihnen nicht wegnehmen (falls Ihre Geräte beschlagnahmt werden).
    *   Siehe Szenario: `Frühjahrsputz für alte Nachrichten und Daten`.
    *   1Password-Nutzer können den [Reisemodus](https://support.1password.com/travel-mode/) der App nutzen, um bestimmte Passwörter während einer Reise vom Gerät zu entfernen.
...
*   **Erwägen Sie, Ihre Geräte während der Überfahrt auszuschalten.**
    *   Speichermedien/Festplatten sind nur verschlüsselt, wenn sie ausgeschaltet sind, _nicht_ wenn sie sich lediglich im Ruhemodus befinden.
...
_Hinweis: Einige dieser Vorgehensweisen könnten Verdacht erregen und nach hinten losgehen._
...
*   **Seien Ihnen bewusst, dass Mobilfunkunternehmen Ihren Standort und Ihre persönlichen Daten** ohne Ihre Erlaubnis an Dritte**weitergeben könnten**.
*   **Richten Sie vorab ein VPN ein, um:**
    ...
    *   Empfohlene Apps: [Mullvad](https://mullvad.net/), [IVPN](https://www.ivpn.net/) 💰
*   **Laden Sie diese Offline-Apps herunter, falls es zu Verbindungsproblemen kommt:**
    *   **Eine Offline-Messaging-App**, mit der du über Bluetooth Textnachrichten an Personen in Ihrer Nähe senden kannst, falls das Internet ausfällt.
        *   Empfehlung: [Bridgefy](https://bridgefy.me/) – _Sie mussen die App jedoch mit einer Internetverbindung öffnen, um Ihr Konto einzurichten!_
    *   **Eine Offline-Karten-App**
        *   Empfohlen: [Organic Maps](https://organicmaps.app/)
*   **Überprüfen Sie erneut, welche Online-Plattformen sicher zu nutzen sind.**
    *   Sehen Sie in den Transparenzberichten nach, wie oft eine Plattform ihre Daten weitergibt.
        *   [Google-Transparenzbericht: Anfragen nach Nutzerinformationen](https://transparencyreport.google.com/user-data/overview)
        *   [Facebook-Transparenzbericht: Behördliche Anfragen nach Nutzerdaten](https://transparency.facebook.com/)
        *   [X/Twitter-Transparenzzentrum: Informationsanfragen](https://transparency.twitter.com/en/reports/information-requests.html)
        *   [Apple-Transparenzbericht](https://www.apple.com/legal/transparency/)
    *   Ermitteln Sie den Standort des weltweiten Hauptsitzes der Plattform und finden Sie heraus, wo sich die nächstgelegene lokale/regionale Niederlassung befindet. Der Standort beeinflusst die Beziehung der Plattform zu den Behörden und ihre Datenschutzrichtlinien.
...
*   **Wenden Sie sich an Online- (und Offline-)Communities, in denen Sie aktives Mitglied sind, und bitten Sie um Hilfe.** Lesen Sie den Artikel von PEN America zum Thema [„Deploying Your Supportive Cyber Communities](https://onlineharassmentfieldmanual.pen.org/deploying-supportive-cyber-communities/)“.
*   **Teilen Sie Ihre Geschichte** auf [der Storytelling-Plattform von Right To Be](https://stories.righttobe.org/), wo die „Community Ihnen helfen kann, Missbrauch auf Social-Media-Plattformen zu dokumentieren oder zu melden, sowie Ihnen Unterstützungsbotschaften zu senden“.
...
*   **Möchten Sie eine gründlichere Suche durchführen?** Lesen Sie [den „Self-Doxing Guide“](https://guides.accessnow.org/self-doxing.html) der Access Now Digital Security Helpline.
...
*   **Beobachten und archivieren Sie Webseiten, auf denen Sie erwähnt werden**. Empfohlene Tools:
    *   [ChangeTower](https://changetower.com/) oder [Visualping](https://visualping.io/)
*   **Protokollieren Sie Vorfälle (Datum, Uhrzeit, Beschreibung, Screenshot, URL) in dem Programm/der App, das/die für Sie am besten zugänglich ist.** Wenn es viele Screenshots vom Smartphone gibt, nutzen Sie die [Hunchly Mobile](https://hunch.ly/mobile) App, um diese zu organisieren und mit Anmerkungen zu versehen.
*   **Wenn künftige rechtliche Schritte wahrscheinlich sind, beauftragen Sie [Page Vault](https://www.page-vault.com), einen Screenshot der Website zu erstellen.** Bitten Sie einen Anwalt, einen [Antrag auf Beweissicherung](https://onlinesos.org/blog/evidence-preservation-i-e-litigation-hold-request) bei der entsprechenden Online-Plattform zu stellen.
...
Weitere Tipps, wie Sie effektiv zurückschlagen können, finden Sie in [den Richtlinien](https://onlineharassmentfieldmanual.pen.org/guidelines-for-safely-practicing-counterspeech/) von PEN America [für den sicheren Einsatz von Gegenrede](https://onlineharassmentfieldmanual.pen.org/guidelines-for-safely-practicing-counterspeech/).
...
*   **Anrufe von einer bestimmten Nummer stummschalten:**
    ...
    *   iOS: Erstellen Sie einen neuen `Fokusmodus`, indem Sie [diese Anweisungen von Tom’s Guide](https://www.tomsguide.com/how-to/how-to-silence-a-specific-contact-on-your-iphone) befolgen.
...
*   **Anrufe von allen unbekannten Nummern blockieren:**
    *   Android:
*   **Zeigen Sie die Nummer an, wenn sich ein Anrufer hinter einer `„Keine Anrufer-ID` “-Einstellung versteckt**, indem Sie eine App wie [TrapCall](https://www.trapcall.com/) verwenden.
...
*   **Wenn die Belästigung auf einer Social-Media-Plattform stattfindet**: Reichen Sie eine Meldung bei dem Social-Media-Unternehmen ein und bitten Sie mindestens 10 Freunde, dasselbe zu tun. Lassen Sie 1–2 Personen eine Beschwerde wegen Urheberrechtsverletzung einreichen, wenn dies sinnvoll ist.
    *   **Sehen Sie sich die entsprechenden Meldelinks für die folgenden Dienste an:**
...
*   **Wenn sich auf einer Website belästigendes Material befindet:** Reichen Sie eine Meldung beim Webhosting-Anbieter und beim Domain-Registrar der Website ein. Sie können möglicherweise herausfinden, um welche Unternehmen es sich handelt, indem Sie eine [WHOIS-Abfrage](https://lookup.icann.org/) für die Website-Domain durchführen.
...
*   **[Ignoriere Nachrichten](https://www.facebook.com/help/messenger-app/1245152242249842)** innerhalb von Facebook Messenger, um aktuelle und zukünftige Nachrichten in den Bereich `„Nachrichtenanfragen“` zu verschieben
*   **[Der Datenschutz-Check](https://www.facebook.com/privacy/checkup)** innerhalb von Facebook enthält einen Abschnitt zu `„Wer kann sehen, was Sie teilejn`?“, der Ihnen die Sichtbarkeit Ihres Profils und Ihrer Beiträge erklärt.
...
*   **[Schränken](https://help.instagram.com/2638385956221960/)** ein Konto einschränken, was bedeutet, dass die andere Person nicht sehen kann, wann du online bist, ob du ihre Nachrichten gelesen hast, und ihre Kommentare werden ausgeblendet.
*   **[Verbergen](https://help.instagram.com/1177797265575168/)** Ihre Stories vor einem bestimmten Konto.
*   **[Versteckte Wörter](https://help.instagram.com/700284123459336)** filtert Nachrichten und Kommentare mit Wörtern heraus, die Instagram als anstößig einstuft. Du kannst auch eine eigene Wortliste erstellen.
*   **[Einschränken](https://help.instagram.com/4106887762741654)** Kommentare und Nachrichten von neuen Followern und Konten, die Ihnen nicht folgen.
...
*   **[Füge Kommentarfilter hinzu](https://support.tiktok.com/en/using-tiktok/messaging-and-notifications/comments#3)** , indem du manuell Schlüsselwörter eingibst, den TikTok-eigenen Filter für Spam/anstößige Inhalte nutzt oder für alle Kommentare eine manuelle Freigabe verlangst.
*   **[Füge Moderatoren zu Ihrem Livestream hinzu](https://support.tiktok.com/en/live-gifts-wallet/tiktok-live/moderating-on-tiktok-live)** , um Kommentare zu verwalten und unerwünschte Zuschauer zu blockieren.
*   **[Entferne Follower](https://support.tiktok.com/en/using-tiktok/followers-and-following/removing-followers)** aus Ihrem Konto; ehemalige Follower werden nicht benachrichtigt.
...
*   **Wenn Sie jemanden blockieren:**
    ...
    *   Nachrichten, die sie in gemeinsamen Kanälen schreiben, sind ausgeblendet. Nachrichten, die du in gemeinsamen Kanälen schreibst, sind für sie _jedoch_ weiterhin sichtbar.
    *   Sie erscheinen Ihnen jederzeit `als offline`, können aber dennoch Ihren Online-/Offline-Status sehen.
*   **[Datenschutzeinstellungen](https://support.discord.com/hc/en-us/articles/217916488-Blocking-Privacy-Settings-)** ermöglichen es Ihnen, festzulegen, ob Community-/Servermitglieder Ihnen Direktnachrichten senden können und wer Ihnen Freundschaftsanfragen schicken darf.

##### Die Wahl zwischen Stummschalten und Blockieren eines Kontos

*   **Einige Plattformen teilen der anderen Person mit, dass du sie blockiert hast, während andere diese Aktion vollständig verbergen.** Lies diesen [Leitfaden von Consumer Reports](https://www.consumerreports.org/digital-security/can-people-tell-when-blocked-texting-social-messaging-apps-a9942470743/), um zu erfahren, wie das Blockieren für die andere Partei aussieht.
...
*   **Bitten Sie Freunde um Hilfe, um gemeinsam eine Mahlzeit einzunehmen, eine Pause zu machen oder** ein paar Tage**auf Ihr(e) Haustier(e) aufzupassen**.
...
*   **Lade einen verschlüsselten „Hash“ eines missbräuchlichen Fotos oder Videos auf [StopNCII.org](https://stopncii.org/) hoch, damit es von großen Plattformen** wie Facebook, TikTok und Reddit**entfernt wird**.
*   **Finden Sie mit [Alecto AI](https://alectoai.com)** (Beta)**heraus, wo Ihr Gesicht online missbraucht wird**. Der Dienst hilft Ihnen auch bei der Entfernung von Inhalten.
*   **Vernetzen Sie sich mit anderen und teilen Sie Ihre Geschichte** auf [My Image My Choice Storyplace](https://myimagemychoice.storyplace.com/).
*   **Wenden Sie sich an einen lokalen Dienst** aus [der globalen Support-Liste](https://www.esafety.gov.au/key-topics/image-based-abuse/getting-help-outside-australia) von eSafety, [dem globalen Verzeichnis](https://www.chayn.co/global-directory) von Chayn oder den [direkten Support-Ressourcen](https://stopstalkerware.org/resources/) der Coalition Against Stalkerware.
*   **Nehmen Sie an Blooms Kurs zu [bildbasiertem Missbrauch und Selbstwiederherstellung](https://bloom.chayn.co/courses/image-based-abuse-and-rebuilding-ourselves) teil**.
...
*   **Lies [das Gespräch zwischen Lyz Lenz und Talia Lavin](https://lyz.substack.com/p/when-the-mob-comes)** über ihre Erfahrungen.
*   **Senden Sie diese Ressourcen an Ihre Redaktion:**
    *   Fallbuch zur Manipulation von Medien: [Tipps für Redaktionen zur Unterstützung von Journalisten, die Opfer von Online-Belästigung sind](https://mediamanipulation.org/research/tips-newsrooms-support-journalists-targeted-online-harassment/)
    *   Ontheline Newsrooms: [Maßnahmen für Redaktionen und Journalisten zur Bekämpfung von Online-Belästigung](https://newsrooms-ontheline.ipi.media/).

#### Schau Ihnen diese zusätzlichen Ressourcen an

*   PEN America: [Handbuch zum Umgang mit Online-Belästigung](https://onlineharassmentfieldmanual.pen.org/)
*   Hotline für Spiele und Online-Belästigung: [Leitfaden zur digitalen Sicherheit](https://gameshotline.org/online-free-safety-guide/)
...
*   Suchen und löschen Sie einzelne Beiträge manuell mithilfe [der erweiterten Suche](https://twitter.com/search-advanced).
*   Lösche mehrere Beiträge gleichzeitig mit [Cyd](https://cyd.social/), [TweetDelete](https://tweetdelete.net/) oder [Tweet Deleter](https://tweetdeleter.com/) 💰.
...
*   Ändere [die Sichtbarkeitseinstellungen](https://www.linkedin.com/psettings/data-visibility) Ihres Profils. Achte darauf, einzuschränken, `wer deine E-Mail-Adresse sehen oder herunterladen kann` und `wer deine Verbindungen sehen kann`.

##### Reddit und andere Foren

*   Oft gibt es keine einfache Lösung. Manchmal mussen Sie Ihr gesamtes Konto löschen.
*   Im Fall von Reddit mussen Sie [Skripte von Drittanbietern verwenden](https://social.techjunkie.com/how-to-delete-all-reddit-posts/), da Ihre Beiträge auch nach der Löschung Ihres Kontos weiterhin sichtbar bleiben.
...
*   **Facebook** [Lies die Anleitung](https://www.facebook.com/help/224562897555674), um Ihr Konto vorübergehend zu deaktivieren oder zu löschen. Sie haben nach der Deaktivierung 30 Tage Zeit, um den Vorgang rückgängig zu machen.
*   **Instagram** [Lies die Anleitung](https://help.instagram.com/370452623149242/), um Ihr Konto vorübergehend zu deaktivieren, aber das Löschen scheint dauerhaft zu sein.
*   **X/Twitter** [Lies die Anleitung](https://help.twitter.com/en/managing-your-account/how-to-deactivate-twitter-account) zum Deaktivieren Ihres Kontos. Es wird dauerhaft gelöscht, wenn Sie sich nach 30 Tagen nicht einloggen.
*   **Snapchat** [Lies die Anleitung](https://support.snapchat.com/en-US/a/delete-my-account1) zum Löschen Ihres Kontos. Es wird dauerhaft gelöscht, wenn Sie sich nach 30 Tagen nicht einloggen.

#### Entfernen Ihre Daten aus den Konten oder Websites anderer Personen

_Denken Sie daran: Die Bearbeitung von Anträgen auf Löschung von Informationen dauert einige Zeit und erfordert oft wiederholte Versuche._

*   Verwenden [Sie das Google-](https://myactivity.google.com/results-about-you) Tool [„Ergebnisse über Sie“](https://myactivity.google.com/results-about-you), um nach Websites zu suchen, die Ihren Namen, Ihre Telefonnummer, Ihre Privatadresse und/oder Ihre E-Mail-Adresse zusammen aufführen, und beantragen Sie, dass diese aus den Google-Suchergebnissen entfernt werden.
*   Bitten Sie [Google](https://support.google.com/websearch/troubleshooter/3111061?hl=en) und [Bing](https://www.microsoft.com/en-ca/concern/bing), Suchergebnisse zu entfernen, die auf Seiten mit Ihren persönlichen Daten verweisen.
*   [Bitten Sie Google Maps](https://support.google.com/maps/answer/15439776), das Street-View-Bild Ihres Zuhauses zu verwischen.
*   Entfernen Sie alle Bewertungen lokaler Unternehmen, die Sie auf Google Maps, Yelp usw. hinterlassen haben. Diese könnten auf Ihr Zuhause oder häufig besuchte Orte hinweisen.
*   Befolgen Sie den [Leitfaden](https://www.cybercivilrights.org/online-removal) der Cyber Civil Rights Initiative, [um Beiträge/Medien, die gegen die Richtlinien verstoßen, aus sozialen Netzwerken entfernen zu lassen](https://www.cybercivilrights.org/online-removal).
*   Wenn Sie dies selbst tun möchten, sehen Sie sich Yael Grauers [BADBOOL](https://github.com/yaelwrites/Big-Ass-Data-Broker-Opt-Out-List) an. (Um 100 % gründlich zu sein, nutzen Sie dies zusätzlich zu kostenpflichtigen Diensten mit Yaels [„Fill in the Gaps“-Tabelle](https://docs.google.com/spreadsheets/d/115L6LpQg_UX638IyUfdwGhRS7dIU3lKwz6fjAcDtE-0/).)
*   Wenn Sie bereit sind, dafür zu bezahlen 💰, empfiehlt [BADBOOL](https://github.com/yaelwrites/Big-Ass-Data-Broker-Opt-Out-List?tab=readme-ov-file#additional-options-paid-and-free) die Nutzung von [EasyOptOuts](https://easyoptouts.com/), um Ihre Daten von englischsprachigen öffentlichen und kostenpflichtigen Websites zu entfernen.
*   Wenn Sie in den USA leben, hilft [die Permission Slip-App von Consumer Reports](https://www.permissionslipcr.com/) (nur für iOS) dabei, Löschanfragen an über 40 US-Unternehmen zu automatisieren.

#### Entfernen Sie Artikel und Presseberichte über Sie aus dem Internet

_Hinweis: Je größer die Publikation, desto schwieriger ist es, sie zu überzeugen._
...
*   **Richten Sie ein Postfach** bei der Post **ein** oder nutzen Sie [Earth Class Mail](https://www.earthclassmail.com/) (nur in den USA), um Ihre Privatadresse zu verbergen.
    *   Wenn Sie in den USA leben, haben Sie möglicherweise Anspruch auf [das Adressgeheimnisprogramm](https://en.wikipedia.org/wiki/Address_confidentiality_program) Ihres Heimatstaates, wenn Sie Opfer von Missbrauch oder im Gesundheitswesen tätig sind. Die Regeln variieren von Staat zu Staat.
*   **Löschen Sie alte Konten, um Spuren persönlicher Informationen im Internet zu beseitigen.** Nutzen Sie das [JustDeleteMe-](https://justdeleteme.xyz/) Verzeichnis, um diesen Prozess zu beschleunigen.
...
*   Befolgen Sie [diese Anweisungen](https://support.google.com/accounts/answer/3024190), um Ihre Daten (einschließlich E-Mails) mit Google Takeout herunterzuladen.
    *   Um nur E-Mails aus einem bestimmten Zeitraum herunterzuladen, beispielsweise von 2015 bis 2020, erstellen Sie ein Label mit diesem Datumsbereich, indem [Sie diese Anweisungen befolgen](https://support.cloudhq.net/how-to-create-a-gmail-label-with-email-messages-in-certain-date-range/), und wählen Sie dieses Label dann in Google Takeout aus.
*   Befolgen Sie [diese Anweisungen](https://zapier.com/blog/how-to-mass-delete-emails-gmail/#date), um alte E-Mails zu löschen, indem Sie nach einem Datumsbereich filtern und dann alles innerhalb dieses Zeitraums löschen. (Alternativ können Sie, falls Sie ein Label dafür erstellt haben, einfach alles unter diesem Label auswählen.)
...
*   Laden Sie Ihre Nachrichten vor dem Löschen mit [dem](https://github.com/ReagentX/imessage-exporter/) Drittanbieter-Tool [„imessage-exporter“](https://github.com/ReagentX/imessage-exporter/) herunter. Es ist kostenlos, Sie müssen jedoch die Befehlszeile (Terminal-App) verwenden. Wenn Sie mit dem Terminal nicht vertraut sind, [es](https://www.cultofmac.com/how-to/back-up-messages) aber dennoch ausprobieren möchten, [finden Sie in diesem Artikel eine gute Schritt-für-Schritt-Anleitung](https://www.cultofmac.com/how-to/back-up-messages).
...
*   Bevor Sie etwas löschen, laden Ihre Beiträge und Stories herunter, indem Sie [diese Anleitung zum Exportieren Ihrer Instagram-Daten](https://help.instagram.com/181231772500920) befolgen.
*   Die einzige Möglichkeit, vergangene Stories massenweise zu löschen, [besteht darin, die automatische Archivierungsfunktion zu deaktivieren](https://www.facebook.com/help/1935507879999791/). Deaktiviere sie für einen Tag, um vergangene Stories zu löschen, und erwäge, sie danach ebenfalls deaktiviert zu lassen.
...
*   Schließen Sie Ihr Smartphone über ein USB-Kabel an Ihren Computer an und verwenden Sie die App „Bildaufnahme“ ([ausführliche Anleitung hier](https://blinksandbuttons.net/how-to-download-pictures-from-camera-to-mac/)).
...
Wenn jemand aus Ihrem Umfeld (meistens ein Partner) Sie mithilfe einer versteckten App auf Ihrem Mobilgerät ausspioniert, nutzt diese Person _Stalkerware_.
...
*   **Starten Sie Ihr Smartphone** während dieser**Zeit täglich neu**. Manchmal führt dies dazu, dass Spyware-Apps nicht mehr funktionieren.
...
*   **Überprüfen Sie, ob Sie die Standortfreigabe in einer App aktiviert haben.** Anleitung für:
    ...
    *   macOS: [„Mein iPhone suchen“](https://support.apple.com/en-ca/HT210514)
...
*   **Scannen Sie Ihr Telefon mit [iVerify](https://iverify.io/products/basic) auf hochentwickelte Spyware.** Die Basisversion der App kostet nur 1 $ und ermöglicht es Ihnen, einmal im Monat einen forensischen Scan durchzuführen.
...
*   **Überprüfen Sie, ob jemand einen Ortungs-Chip/Tag verwendet, um Sie zu verfolgen.** Glücklicherweise verfügen die beiden beliebtesten Ortungs-Chips/Tags über Anti-Stalking-Funktionen.
    ...
    *   Zusätzliches Tool: AirGuard für [iOS](https://apps.apple.com/us/app/airguard-tracking-protection/id1659427454) und [Android](https://github.com/seemoo-lab/AirGuard)

#### Wenn Sie Ihnenb ziemlich sicher sind, dass er/sie sich ausspioniert, und Sie Angst haben

_Gehen das nicht alleine durch – holen Ihnen Hilfe:_
...
*   **Wenden Sie sich an eine der vielen Organisationen, die sich auf Stalkerware und häusliche Gewalt spezialisiert haben (über ein öffentliches Telefon oder das Telefon eines Freundes).** Einige von ihnen helfen Ihnen dabei, Beweise zu sammeln und Stalkerware sicher zu entfernen.
    *   Siehe die [weltweite Liste der Organisationen für direkte Unterstützung](https://stopstalkerware.org/resources/) der Coalition Against Stalkerware.
*   **Bewahren Sie digitale und gedruckte Aufzeichnungen relevanter Texte, E-Mails, Anrufe usw. auf.**
    *   Siehe [den Leitfaden](https://www.womenslaw.org/about-abuse/abuse-using-technology/evidence-issues-cases-involving-technology/digital-evidence) von NNEDV [zum Dokumentieren/Speichern von Beweismitteln](https://www.womenslaw.org/about-abuse/abuse-using-technology/evidence-issues-cases-involving-technology/digital-evidence).
...
*   Consumer Reports: [Halten Sie Stalker von Ihren technischen Geräten fern](https://www.consumerreports.org/digital-security/shut-stalkers-out-of-your-tech/)
*   Wirecutter: [Schützen Sie Ihre Geräte vor häuslichen Gewalttätern](https://thewirecutter.com/blog/domestic-abusers-can-control-your-devices-heres-how-to-fight-back/)
*   Apple iOS: [Benutzerhandbuch zur persönlichen Sicherheit: Schützen Sie sich selbst und Ihre Daten](https://support.apple.com/en-ca/guide/personal-safety/welcome/web)
...
*   **Verwenden Sie E-Mails so wenig wie möglich.** Selbst Ende-zu-Ende-verschlüsselte E-Mails [hinterlassen eine Spur von Metadaten](https://freedom.press/training/blog/how-reporters-emails-get-got-case-studies-legal-request-hacking/).
*   **Verwenden Sie zum Austausch von Nachrichten eine durchgehend verschlüsselte Messaging-App, die keine Metadaten speichert.** Verwenden Sie keine X/Twitter-DMs!
*   **Verwenden Sie für Sprach- und Videoanrufe ebenfalls eine durchgehend verschlüsselte App.**
*   **Nutzen Sie die Sicherheitsfunktionen in Signal und WhatsApp.** Lesen Sie dazu die Artikel von Martin Shelton zu [„Locking Down Signal](https://medium.com/@mshelton/locking-down-signal-d71678f653d3) “ und [„Upgrading WhatsApp security](https://medium.com/@mshelton/upgrading-whatsapp-security-386c8ce496d3)“.
*   **Um anonyme Hinweise zu erleichtern, lassen Sie Ihre Organisation eine [Hush Line](https://hushline.app/) einrichten**.
*   **Lassen Sie Ihre Organisation für die Übertragung von Dokumenten [SecureDrop](https://securedrop.org/) einrichten.** Falls dies nicht möglich ist, ermutigen Sie die Leute, [OnionShare](https://onionshare.org/) zu nutzen.
*   **Verwischen Sie Gesichter auf Fotos und Videos.** Lesen Sie die entsprechenden Empfehlungen im Szenario `„Teilnahme an einer Demonstration`“.
*   **Siehe Ted Han und Quinn Nortons [„Protecting Your Sources When Releasing Sensitive Documents](https://source.opennews.org/articles/how-protect-your-sources-when-releasing-sensitive-/)“.**
*   **Siehe Martin Sheltons [„Sichere Kanäle für vertrauliche Hinweise einrichten](https://source.opennews.org/articles/opening-secure-channels-confidential-tips/)“.**

#### Schützen Sie sich

*   **Verwenden Sie in Messaging-Apps eine zweite Telefonnummer, um mit Ihren Quellen zu sprechen.**
*   **Richten Sie mit Ihrer zweiten Telefonnummer eine öffentliche Hinweis-Hotline ein.** Befolgen Sie Yael Grauers Anleitung: [„Wie man Signal nutzt, ohne seine Telefonnummer preiszugeben – mit einem Chromebook und einem alten Handy](https://blog.yaelwrites.com/how-to-use-signal-without-giving-out-your-phone-number-using-a-chromebook-and-an-old-phone/)“.
...
*   **Wenn Sie Recherchen in sozialen Medien durchführen,** tun**Sie** dies über ein separates Konto, das einen Pseudonym (nicht Ihren echten Namen) verwendet. Richten Sie dieses Konto mit einer Wegwerf-E-Mail-Adresse ein. (Nicht alle Redaktionen/Arbeitgeber erlauben dies, aber gehen Sie so weit wie möglich an die Grenzen des Erlaubten.)
*   **Verbergen Sie gegenüber den von Ihnen besuchten Websites, woher Sie kommen.** Verwenden Sie ein VPN oder [den Tor-Browser](https://www.torproject.org/), insbesondere wenn Sie zu Hause oder im Büro im Internet surfen. Sie möchten beispielsweise nicht, dass Website-Administratoren sehen, dass Sie über das Netzwerk der Redaktion _der New York Times_ zugreifen.

#### Schützen Sie Ihre Daten

_Hinweis: [Gerichte können Unternehmen wie Google dazu verpflichten, alle Ihre Daten herauszugeben](https://medium.com/@tinfoilpress/newsrooms-lets-talk-about-g-suite-1672a36eb235)._
...
*   **Verlagern Sie Ihre gesamte Arbeit auf Plattformen mit End-to-End-Verschlüsselung.**
    *   Empfohlene E-Mail-Plattformen: [Proton Mail](https://protonmail.com/), [Tuta Mail](https://tutanota.com/)
    *   Empfohlene Plattform für Dokumente/Tabellen: [CryptPad](cryptpad.fr/)
    *   Empfohlene Cloud-Speicherplattformen: [Tresorit](https://tresorit.com/), [Proton Drive](https://proton.me/drive)
...
*   **Löschen Sie sensible Dateien dauerhaft von Ihrem Computer.** Empfohlene Apps:
    *   macOS: [CleanMyMac X](https://macpaw.com/cleanmymac) (die Dateischredder-Funktion ist in der kostenlosen Testversion enthalten)
...
*   **Suchen, sperren oder löschen Sie Ihr Gerät aus der Ferne.** Anleitungen für:
    *   iOS und macOS: [Find My](https://support.apple.com/HT210515)
    *   Android: [Find Hub](https://support.google.com/accounts/answer/6160491)
    *   Windows: [„Mein Gerät suchen“](https://support.microsoft.com/account-billing/find-and-lock-a-lost-windows-device-890bf25e-b8ba-d3fe-8253-e98a12f26316)
...
*   **Wenn die Behörden Ihr Gerät an einem internationalen Grenzübergang beschlagnahmen, verlangen Sie eine Beschlagnahmungsbescheinigung** (in einigen Ländern, wie z. B. [Kanada](https://bccla.org/wp-content/uploads/2018/10/Electronic-Devices-Privacy-Handbook-BCCLA_2.0.pdf), verfügbar).
...
*   **Laden Sie Apps von Drittanbietern herunter, die Netzwerkverbindungen analysieren und Malware auf Ihren Geräten erkennen:**
    ...
    *   [Charles Proxy](https://www.charlesproxy.com/) für Windows, macOS, Linux
    *   [Glasswire](https://www.glasswire.com/) für Windows, Android
    *   [Little Snitch](https://www.obdev.at/index.html) für macOS
    *   [Objective-See-Tools](https://objective-see.org/index.html) für macOS
    *   [iVerify](https://iverify.io/products/basic) für iOS, Android
*   **Richte ein Ersatzhandy als Raumüberwachung ein**, um unerwünschtes Eindringen zu erkennen. Beispiel-Apps:
    *   [Alfred](https://alfred.camera/) für iOS & Android
    *   [Haven](https://guardianproject.info/apps/org.havenapp.main/) für Android
*   **Versetzen Sie Ihr Smartphone oder Tablet in den „Lockdown-Modus“ (nur iOS)**, um die meisten eingehenden Nachrichten und Verbindungen zu blockieren, während Sie die Situation klären:
    *   [Lesen Sie den Artikel des Apple-Supports dazu.](https://support.apple.com/en-us/HT212650)
    *   `Einstellungen → Datenschutz & Sicherheit → Sperrmodus → Sperrmodus aktivieren`
...
2.  Für Opfer geschlechtsspezifischer Gewalt: Siehe [das globale Verzeichnis](https://www.chayn.co/global-directory) von Chayn, [die direkten Hilfsressourcen](https://stopstalkerware.org/resources/) der Coalition Against Stalkerware und [die globale Unterstützungsliste](https://www.esafety.gov.au/key-topics/image-based-abuse/getting-help-outside-australia) von eSafety.
3.  Für Mitglieder der Zivilgesellschaft: Siehe [die Liste](https://securitylab.amnesty.org/digital-resources/) des Amnesty International Security Lab [mit Helplines und Helpdesks für digitale Resilienz und Sicherheit](https://securitylab.amnesty.org/digital-resources/).

#### Wenn jemand anderes die Kontrolle über Ihre Konten übernommen hat

*   Siehe [die Liste mit Anleitungen zur Wiederherstellung des Zugriffs](https://securityplanner.consumerreports.org/tool/regain-control-of-hacked-accounts) von Consumer Reports Security Planners.

#### Wenn Sie Opfer eines Online-Betrugs, einer Betrugsmasche oder von Ransomware geworden sind

*   Siehe [die Liste](https://support.microsoft.com/en-us/windows/protect-your-pc-from-ransomware-08ed68a7-939f-726c-7e84-a72ba92c01c3) von Microsoft [mit Websites zur Meldung von Betrug und Betrugsversuchen durch Behörden](https://support.microsoft.com/en-us/windows/protect-your-pc-from-ransomware-08ed68a7-939f-726c-7e84-a72ba92c01c3) (scrollen Sie nach unten zu „Was tun, wenn Sie bereits bezahlt haben?“).

#### Wenn Sie Informationen sicher an Journalisten senden müssen

*   [Drop a News Tip](https://docs.google.com/spreadsheets/d/e/2PACX-1vSRFKbJUtFQ55uB5NSaIgxUwQM8qRGMwLyybDWhqmqbCba_zaeDo5L7i3yJv8vb_Q_VqRvIwOcRKDeJ/pubhtml) bietet eine Liste mit über 50 Nachrichtenorganisationen aus aller Welt, bei denen Sie Informationen über SecureDrop und/oder eine Ende-zu-Ende-verschlüsselte Messaging-App einreichen können.
...
*   **Schreiben und machen Sie sich Notizen in Ende-zu-Ende-verschlüsselten Apps.** Verwenden Sie statt Google Docs oder Microsoft Office [CryptPad](https://cryptpad.fr) oder [Standard Notes](https://standardnotes.org/). Beide sind Open-Source und kostenlos nutzbar.
*   **Teilen Sie Dateien anonym** mit [OnionShare](https://onionshare.org/).
*   **Erstellen Sie eine temporäre, halböffentliche E-Mail-Adresse für den einmaligen Gebrauch** bei [Maildrop](https://maildrop.cc/).
*   **Machen Sie verdächtige PDF-Dateien** mit [Dangerzone](https://dangerzone.rocks)**sicher**.
*   **Passen Sie Ihre Einstellungen `für die geschützte Ansicht` an (nur Windows)**, wenn Sie viele Dateien in [Microsoft Office](https://support.microsoft.com/en-us/office/what-is-protected-view-d6f09ac7-e6b9-4495-8e43-2bbcdbcb6653) und [Adobe Acrobat](https://helpx.adobe.com/acrobat/using/protected-view-feature-pdfs-windows.html) öffnen.
*   **Probieren Sie eine neue, durchgehend verschlüsselte Messaging-App aus.** Es ist immer gut, mehr als eine installiert zu haben, falls es zu einem Serverausfall kommt. Einige Optionen finden Sie in Mark Williams’ [Vergleich von sicheren Messaging-Apps](https://www.securemessagingapps.com/).
*   **Versende Ende-zu-Ende-verschlüsselte E-Mails** mit [Proton Mail](https://protonmail.com/) oder [Tuta Mail](https://tutanota.com/).
*   **Finden Sie einen durchgehend verschlüsselten Videotelefoniedienst** mithilfe [des Leitfadens von Freedom of the Press](https://freedom.press/training/blog/videoconferencing-tools/).
*   **Versenden Sie eine selbstzerstörende, passwortgeschützte Nachricht** mit [One Time](https://onetimesecret.com/).
*   **Melden Sie sich bei [„Have I Been Pwned“](https://haveibeenpwned.com/) an, um benachrichtigt zu werden**, wenn ein mit Ihrer E-Mail-Adresse verknüpftes Konto kompromittiert wurde.
*   **Suchen Sie** mit [nRF Connect](https://www.nordicsemi.com/Products/Development-tools/nrf-connect-for-mobile)**nach Bluetooth-Geräten in Ihrer Nähe** (einschließlich AirTags).
*   **Verstärken Sie die Schutzmaßnahmen für Ihre Konten:**
    *   [Googles „Advanced Protection“-Programm](https://landing.google.com/advancedprotection/): schreibt Passkeys oder Sicherheitsschlüssel vor, ist besonders vorsichtig bei Downloads und schränkt die Funktion „Mit Google anmelden“ für Google-Konten, -Apps und -Geräte ein.
    *   [Apple iClouds „Advanced Data Protection](https://support.apple.com/guide/security/sec973254c5f/web)“: Aktiviert End-to-End-Verschlüsselung für einige iCloud-Apps, jedoch nicht für Mail/Kontakte/Kalender.
    *   [Proton Sentinel](https://proton.me/support/proton-sentinel) 💰: Erstellt detailliertere Protokolle zu „Sicherheitsereignissen“ und bietet besseren Support durch Mitarbeiter rund um die Sicherheit für Proton-Dienste/Apps.
*   **Einwohner der USA: Sperren Sie Ihre Kreditwürdigkeit**, um zu verhindern, dass böswillige Akteure auf Ihre persönlichen Daten zugreifen oder diese missbrauchen. Aktivieren Sie sie einfach wieder, wenn Sie sie benötigen. Weitere Informationen finden Sie [im Leitfaden zur Kreditsperre](https://inteltechniques.com/freeze.html) von IntelTechniques.

### Tools & Tipps, die Geld kosten

*   **Kaufen Sie einen [USB-YubiKey](https://www.yubico.com/products/) für die Zwei-Faktor-Authentifizierung.** Wenn Sie im Bereich Meinungsfreiheit, Presse oder Internet tätig sind, haben Sie möglicherweise Anspruch auf einen kostenlosen [Yubico for Free Speech](https://www.yubico.com/about/about-us/free-speech-program/).
*   **Verwenden Sie [den Reisemodus von 1Password](https://support.1password.com/travel-mode/)**, um eine Reihe von Passwörtern zu erstellen, die Sie nicht mit auf Reisen nehmen.
*   **Bewahren Sie Ihre Smartcards, Reisepässe und Telefone in einer Faraday-Tasche auf, die den Ein- und Ausgang von Signalen blockiert.** (Siehe [dazu den Leitfaden von Micah Lee](https://micahflee.com/2015/11/some-thoughts-on-faraday-bags-and-operational-security/).)
*   **Kaufen Sie einen Mikrofonblocker** von [Mic-Lock](https://mic-lock.com/), den Sie an Ihr Telefon anschließen können, um dessen Mikrofon stummzuschalten.
*   **Besorgen Sie sich einen sicherheitsorientierten Router** von [pcWRT](https://www.pcwrt.com/) oder [Peplink](https://www.peplink.com/).
*   **Kaufen Sie eine hardwareverschlüsselte externe USB-Festplatte oder ein Festplattenlaufwerk** von Anbietern wie [Apricorn](https://www.apricorn.com/).

### Tools & Tipps mit steiler Lernkurve

*   **Nutzen Sie einen spezialisierten DNS-Dienst** wie [Quad9](https://www.quad9.net/)**für den Internetzugang**.
*   **Nutzen Sie eine dezentrale, private Messaging-App, die auf dem Tor-Netzwerk basiert**. Schauen Sie sich [Ricochet Refresh](https://www.ricochetrefresh.net/) an.
*   **Greifen Sie mit mehr Anonymität auf Facebook zu und umgehen Sie Internetfilter, indem Sie [dessen Onion-Dienst](https://en.wikipedia.org/wiki/Facebookcorewwwi.onion) nutzen.**
...
*   **Sichern Sie Ihr Android-Smartphone ab**, um mehr Sicherheit und Privatsphäre zu gewährleisten:
    *   **Verwenden Sie [F-Droid](https://f-droid.org)**: einen auf Sicherheit ausgerichteten Open-Source-App-Store.
    *   **Ersetzen Sie das** vorinstallierte **Betriebssystem** Ihres Smartphones:
        *   Wenn Sie ein Google-Smartphone besitzen, installieren Sie [GrapheneOS](https://grapheneos.org/) oder [CalyxOS](https://calyxos.org/).
...
*   **Lesen Sie [diesen EDRi-Leitfaden zur ethischen Website-Entwicklung und -Pflege](https://edri.org/ethical-web-dev/).** Achten Sie besonders auf die Empfehlungen zum Datenschutz.
*   **Schützen Sie Ihre Website vor DDOS-Angriffen und anderen Bedrohungen, indem Sie**
    *   **[Deflect](https://deflect.ca/).** Es gibt einen [kostenlosen Tarif]([https://deflect.ca/nonprofit](https://deflect.ca/nonprofit) für gemeinnützige Organisationen.
    *   **[Cloudflare](https://www.cloudflare.com/).** Es gibt einen [kostenlosen Tarif](https://www.cloudflare.com/galileo/) für Organisationen aus den Bereichen Kunst, Menschenrechte, Zivilgesellschaft, Journalismus oder Demokratie.
    *   **[Project Shield](https://projectshield.withgoogle.com) von Google.** Nur verfügbar für Nachrichten-, Menschenrechts- und Wahlbeobachtungsseiten.
*   **Wenn Sie WordPress verwenden, sollten Sie die folgenden Plugins in Betracht ziehen**
    *   **[Wordfence](https://wordpress.org/plugins/wordfence/)**
    *   **[Sucuri Security](https://wordpress.org/plugins/sucuri-scanner/)**
    *   Wenn Ihr Hosting-Anbieter keine Backups anbietet, nutzen Sie [VaultPress](https://jetpack.com/upgrade/backup/) oder [BackupBuddy](https://ithemes.com/backupbuddy/).
    *   Alternativ können Sie [Simply Static](https://simplystatic.com/) nutzen, um Ihre öffentlich zugängliche WordPress-Website in eine statische Website umzuwandeln.
*   **Verwenden Sie einen datenschutzorientierten Analysedienst** wie [Matomo](https://matomo.org/) oder [Koko Analytics](https://www.kokoanalytics.com/).
*   **Erwägen Sie den Wechsel zu einem datenschutzorientierteren Hosting-Dienst** wie [Greenhost](https://greenhost.net/), [Maadix](https://maadix.net/en/) oder [1984](https://1984.hosting/).
*   **Richten Sie eine [security.txt](https://securitytxt.org/) -Datei ein**, damit Forscher einen Ort haben, an dem sie Sicherheitslücken melden können.
*   **Richten Sie eine robots.txt-Datei ein**, indem Sie [diese ai.robots.txt-Liste](https://github.com/ai-robots-txt/ai.robots.txt) verwenden, um zu verhindern, dass KI-Unternehmen Ihre Daten crawlen und scrapen.

---

_🏆 Oh je, Sie sind angekommen. Das ist das Ende. Danke fürs Lesen. Danke für Ihre Gründlichkeit. Sie sind ein echter Champion._
...
*   Consumer Reports: [Sicherheitsplaner](https://securityplanner.consumerreports.org/)
*   Electronic Frontier Foundation: [Selbstverteidigung gegen Überwachung](https://ssd.eff.org/)
*   Michael Horowitz: [Eine Checkliste für defensives Computing](https://defensivecomputingchecklist.com/)

### 📝 Lizenz

Dieses Werk ist unter einer [Creative Commons Namensnennung – Nicht kommerziell – Weitergabe unter gleichen Bedingungen 4.0 International Lizenz](http://creativecommons.org/licenses/by-nc-sa/4.0/) lizenziert.

### 👋🏾 Besonderer Dank

Besonderer Dank gilt [unseren GitHub-Mitwirkenden](https://github.com/narwhalacademy/zebra-crossing/graphs/contributors) und Community-Mitgliedern, die uns ihre Bearbeitungen, Vorschläge und Übersetzungen geschickt haben.